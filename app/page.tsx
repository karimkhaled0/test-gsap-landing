      ...
      <div className="studio" ref={studioRef}>
        ...
        <section className="studio-header">
          <div className="studio-header-copy">
            <Copy>
              <h2>
                At KARIM Agency, we are a team of creatives and strategists who
                are passionate about helping businesses grow and succeed.
              </h2>
            </Copy>
          </div>
        </section>
        ...
        <section className="mission-intro">
          ...
          <div className="mission-intro-col-lg">
            <div className="mission-intro-copy">
              <Copy>
                <h3>
                  We are a team of creatives and strategists who are passionate
                  about helping businesses grow and succeed. We are dedicated to
                  creating clear and purposeful online experiences. Our work is
                  rooted in structure, guided by systems, and shaped through
                  close collaboration.
                </h3>
                <br />
                <h3>
                  With a focus on design and development, we build scalable
                  solutions that reflect precision and long-term value. Every
                  project is an exercise in restraint, intention, and technical
                  care.
                </h3>
              </Copy>
        ...
        <section className="recognition">
          <div className="recognition-copy">
            <Copy>
              ...
              <br />
              <h2>
                Our work has been recognized by businesses and creatives for its
                clarity, consistency, and attention to detail. We focus on
                building systems that go beyond visuals experiences.
              </h2>
            </Copy>
          </div>
        </section>
